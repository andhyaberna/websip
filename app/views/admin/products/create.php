...
<form action="<?php echo base_url('admin/products/create'); ?>" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
               ...
               value="<?php echo isset($_SESSION['old']['title']) ? htmlspecialchars($_SESSION['old']['title']) : ''; ?>">
    </div>
    ...
    <div class="mb-4">
        ...
        <div class="relative">
            <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" 
                    id="type" name="type">
                <option value="product" <?php echo (isset($_SESSION['old']['type']) && $_SESSION['old']['type'] === 'product') ? 'selected' : ''; ?>>Product</option>
                <option value="bonus" <?php echo (isset($_SESSION['old']['type']) && $_SESSION['old']['type'] === 'bonus') ? 'selected' : ''; ?>>Bonus</option>
            </select>
    ...
    <div class="mb-6">
        ...
        <div class="relative">
            <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" 
                ...
                <option value="links" <?php echo (isset($_SESSION['old']['content_mode']) && $_SESSION['old']['content_mode'] === 'links') ? 'selected' : ''; ?>>Links List</option>
                <option value="html" <?php echo (isset($_SESSION['old']['content_mode']) && $_SESSION['old']['content_mode'] === 'html') ? 'selected' : ''; ?>>HTML Content</option>
            </select>
            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
            </div>
    ...
    <div id="links-section" class="mb-6">
        ...
        <div id="links-container" class="space-y-3">
            <?php 
            $oldLinks = isset($_SESSION['old']['links']) ? $_SESSION['old']['links'] : [];
            // Handle if old links is JSON string (edge case) or array
            if (is_string($oldLinks)) $oldLinks = json_decode($oldLinks, true) ?? [];
    ...
    <div id="html-section" class="mb-6 hidden">
        ...
        <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 font-mono leading-tight focus:outline-none focus:shadow-outline" 
                  id="html_content" name="html_content" rows="10" placeholder="<p>Enter your HTML content here...</p>"><?php echo isset($_SESSION['old']['html_content']) ? htmlspecialchars($_SESSION['old']['html_content']) : ''; ?></textarea>
